...
# Actual data: http://python-data.dr-chuck.net/regex_sum_334245.txt (There are 93 values and the sum ends with 381)
...
import re
file = open('regex_sum_334245.txt', 'r')
sum = 0

for line in file :
    numArray = re.findall('[0-9]+', line)
    for num in numArray :
        sum = sum + int(num)
